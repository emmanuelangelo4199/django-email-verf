"""
Django settings for em_pro project.
...
SECRET_KEY = 'django-insecure-m#udb=7-@o%%%o(evns0z+xk24k13ot6dnuaz^)cl@nt7c!3oy'
...
WSGI_APPLICATION = 'em_pro.wsgi.application'
